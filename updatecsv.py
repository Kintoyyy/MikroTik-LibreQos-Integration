...
_wan_manager = WANManager(connect_to_router)
        ...
        try:
            ...
            if any_changes:
                ...
                if cores and wan_sources.get('enabled', True):
                    wan_totals = _wan_manager.assign_wan_nodes(conn, cores, wan_sources)
                    _wan_manager.check_wan_capacity(wan_totals, cores)
                    _wan_manager.sync_wan_address_lists(conn, cores)
